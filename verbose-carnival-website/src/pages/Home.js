    ...
    return (
        <Grid item xs={12} sm={6} md={4} lg={3} xl={2} component={Card} className={classes.projCard}>
            <CardMedia
                ...
                title={title}
            />
            <CardContent className={classes.projCardContent}>
...
function Home() {
    ...
    return (
        <main className={classes.root}>
            ...
            <Grid container className={classes.sectionOdd} justify="center">
                <Grid item xs={12}>
                    <Typography variant="h2" className={classes.subTitle}>Skills & Experience</Typography>
                </Grid>
                <Grid item component={Card} className={classes.card} xs={12} lg={5}>
                    <CardContent>
                        <Typography variant="h6">Proficient</Typography>
                        <Tooltip title="Java">
                            <svg viewBox="0 0 128 128" width="100" height="100" /* Java */ className={classes.svg}>
                        ...
                        <Tooltip title="JavaScript">
                            <svg viewBox="0 0 128 128" width="100" height="100" className={classes.svg}>
                        ...
                        <Tooltip title="React">
                            <svg viewBox="0 0 128 128" width="100" height="100" /* React */ className={classes.svg}>
                        ...
                        <Tooltip title="Node.js">
                            <svg viewBox="0 0 128 128" width="100" height="100" /* Node.js */ className={classes.svg}>
                        ...
                        <Tooltip title="HTML">
                            <svg viewBox="0 0 128 128" width="100" height="100" /* HTML */ className={classes.svg}>
                        ...
                        <Tooltip title="CSS">
                            <svg viewBox="0 0 128 128" width="100" height="100" /* CSS */ className={classes.svg}>
                        ...
                        <Tooltip title="C">
                            <svg viewBox="0 0 128 128" width="100" height="100" /* C */ className={classes.svg}>
                        ...
                        <Tooltip title="Python">
                            <svg viewBox="0 0 128 128" width="100" height="100" /* python */ className={classes.svg}>
                ...
                <Grid item component={Card} className={classes.card} xs={12}  lg={5}>
                    <CardContent>
                        ...
                        <Typography variant="body1" className={classes.desc}> - <strong>Project Manager Assistant</strong>: Learned how to manage agile software development. Wrote user stories based off
                                    client requirements for a fitness app, marketing app, and safety rating app for public places. </Typography>
                        <Typography variant="body1" className={classes.desc}> - <strong>QA Tester</strong>: Learned how to write and properly outline bug reports. Worked mainly on an android app for
                                Flywheel Sports, a company that provides in-studio and on-demand cycling classes.</Typography>
                    </CardContent>
                </Grid>
            </Grid>
            <Grid container direction="row-reverse" justify="flex-start" alignItems="center" spacing={1} className={classes.sectionEven}>
